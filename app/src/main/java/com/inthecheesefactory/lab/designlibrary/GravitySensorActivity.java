...
public class GravitySensorActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSensor != null) {
            ...
            thread = new Thread(new GravitySensorActivity.GameThread());
            thread.start();
        } else {
    ...
    private void initInstances() {
        ...
        drawerToggle = new ActionBarDrawerToggle(GravitySensorActivity.this, drawerLayout, R.string.hello_world, R.string.hello_world);
    ...
    class GameThread implements Runnable {
        ...
        public void run() {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                //Send message
                GravitySensorActivity.this.mHandler.sendMessage(message);
                try {
                    Thread.sleep(100);
